...
func (*BuildResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_buildservice_f3a39e8353bd26e3, []int{0}
}
...
func (*PushFileMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_buildservice_f3a39e8353bd26e3, []int{1}
}
...
func (*PushFileResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_buildservice_f3a39e8353bd26e3, []int{2}
}
...
func (*DeleteMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_buildservice_f3a39e8353bd26e3, []int{3}
}
...
type BuildServiceClient interface {
	...
	Project(ctx context.Context, opts ...grpc.CallOption) (BuildService_ProjectClient, error)
...
func (c *buildServiceClient) Project(ctx context.Context, opts ...grpc.CallOption) (BuildService_ProjectClient, error) {
	stream, err := c.cc.NewStream(ctx, &_BuildService_serviceDesc.Streams[2], "/service.BuildService/Project", opts...)
	if err != nil {
		return nil, err
	}
	x := &buildServiceProjectClient{stream}
	return x, nil
}

type BuildService_ProjectClient interface {
	Send(*PackageNode) error
	CloseAndRecv() (*BuildResponse, error)
	grpc.ClientStream
}

type buildServiceProjectClient struct {
	grpc.ClientStream
}

func (x *buildServiceProjectClient) Send(m *PackageNode) error {
	return x.ClientStream.SendMsg(m)
}

func (x *buildServiceProjectClient) CloseAndRecv() (*BuildResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(BuildResponse)
...
type BuildServiceServer interface {
	...
	Project(BuildService_ProjectServer) error
...
func _BuildService_Project_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BuildServiceServer).Project(&buildServiceProjectServer{stream})
}

type BuildService_ProjectServer interface {
	SendAndClose(*BuildResponse) error
	Recv() (*PackageNode, error)
	grpc.ServerStream
}

type buildServiceProjectServer struct {
	grpc.ServerStream
}

func (x *buildServiceProjectServer) SendAndClose(m *BuildResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *buildServiceProjectServer) Recv() (*PackageNode, error) {
	m := new(PackageNode)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var _BuildService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "Project",
			Handler:       _BuildService_Project_Handler,
			ClientStreams: true,
		},
		{
...
func init() { proto.RegisterFile("buildservice.proto", fileDescriptor_buildservice_f3a39e8353bd26e3) }

var fileDescriptor_buildservice_f3a39e8353bd26e3 = []byte{
	// 384 bytes of a gzipped FileDescriptorProto
	,
}
