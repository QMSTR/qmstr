...
func (r *HTMLReporter) CreatePackageLevelReports(packageNode *service.PackageNode, cserv service.ControlServiceClient, rserv service.ReportServiceClient, enableWarningsErros bool) error {
	...
	for _, node := range packageNode.Targets {
		if err := r.CreateTargetLevelReports(node, cserv, rserv, enableWarningsErros); err != nil {
