...
func (*ReporterConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_reportservice_1a5aa86ca5267448, []int{0}
}
...
func (*ReporterConfigResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_reportservice_1a5aa86ca5267448, []int{1}
}
...
func (*InfoDataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_reportservice_1a5aa86ca5267448, []int{2}
}
...
func (*InfoDataResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_reportservice_1a5aa86ca5267448, []int{3}
}
...
func init() { proto.RegisterFile("reportservice.proto", fileDescriptor_reportservice_1a5aa86ca5267448) }

var fileDescriptor_reportservice_1a5aa86ca5267448 = []byte{
